...
import { getTypeScriptLanguageService } from './services/typescript';
import { getTypescriptMode } from './modes/typescriptMode';
...
export function getLanguageModes(): LanguageModes {
    ...
    const tsLanguageService = getTypeScriptLanguageService();
    ...
    modes['typescript'] = getTypescriptMode(tsLanguageService, documentRegions);
    modes['javascript'] = getTypescriptMode(tsLanguageService, documentRegions); // Reuse TS mode for JS
